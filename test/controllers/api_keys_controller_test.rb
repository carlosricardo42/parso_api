...
class ApiKeysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_key" do
    assert_difference('ApiKey.count') do
      post api_keys_url, params: { api_key: { integer: @api_key.integer, string: @api_key.string, string: @api_key.string } }
    end
  ...
  test "should update api_key" do
    patch api_key_url(@api_key), params: { api_key: { integer: @api_key.integer, string: @api_key.string, string: @api_key.string } }
